...
def train_model(config_file):
    ...
    if train == True:
        ...
        resnet = VGG19(input_shape = img_size +[3], weights = 'imagenet', include_top = False)  # exluding the first layer of VGG19

        for p in resnet.layers:
            p.trainable = False                                                                 # changing the params into false
        ...
        test_gen = ImageDataGenerator(rescale = 1./255)                                         # converting into pixels is enough
